  ...
  return (
    (n = [
      ...
      function (M, t, e) {
        ...
        f.on(window, w, () => {
          for (const t of y.find('[data-mdb-spy="scroll"]'))
          ...
          _bindActivateEvent() {
            s.on(this._scrollElement, Er, (t) => {
              this._showSubsection(),
                ...
                s.trigger(this._scrollElement, xr, {
                  relatedTarget: t.relatedTarget,
                });
            });
          }
        ...
        const Ys = "ArrowDown",
          ...
          $s = "show".concat(w),
          Gs = "shown".concat(w);
        (g = "click".concat(w).concat(v)),
          (E = "keydown".concat(w).concat(v)),
          (e = "keyup".concat(w).concat(v));
        const Zs = "show",
