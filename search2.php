...
<head>
    ...
    <script type="text/javascript" src="https://code.jquery.com/jquery-3.6.2.min.js">
    </script>
                ...
                <div class="nav-menu-items d-flex justify-content-between w-50">
                    ...
                    <div class="dropdown btn-group">
                        ...
                        <ul class="dropdown-menu  text-center" style="background:#D9D9D9 ;">
                            ...
                            <li><a class="dropdown-item text-black" href="./Main.php ">New Release</a>
                            </li>
                            <li><a class="dropdown-item text-black" href="./Main.php ">Top sellers</a>
                            </li>
                            <li><a class="dropdown-item text-black" href="./Main.php ">Game Category
                                </a></li>
                        </ul>
                    ...
                    <div class="dropdown btn-group">
                        ...
                        <ul class="dropdown-menu text-center" style="background: #D9D9D9">
                            <li><a class="dropdown-item text-black" href="./about_us.php">2HKT.com</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider bg-black" />
                            </li>
                            <li><a class="dropdown-item text-black" href="https://discord.gg/D7eqPyD6Dk">Join
                                    the
                                    team</a></li>
                        </ul>
                    </div>
                    ...
                    <div class=" dropdown btn-group">
                        ...
                        <ul class="dropdown-menu text-center" style="background:#D9D9D9;">
                            <li><a class="dropdown-item text-black" href="./order_payment.php">Orders
                                    and Payments</a>
                            </li>
                            <li><a class="dropdown-item text-black" href="./account_website.php">Account
                                    and
                                    Website</a></li>
                            <li><a class="dropdown-item text-black" href="./refund_policy.php">Refund
                                    Policy</a></li>
        ...
        <div class="content">
            ...
            <div class="search">
                <form action="" method="POST">
                    ...
                    <input type="search" name="search_name" id="search_name" placeholder="Search">
                    <!-- tới đây-->
                    <span class="cart-items"><a href="./Cart.php"> <i class="fa-solid fa-cart-shopping fa-3x"></i>
                        </a>
                    </span>
